...
constexpr unsigned string_hash(const char * str, unsigned len, unsigned init_value);
...
constexpr unsigned string_hash(const char * str, unsigned length, unsigned init_value) {
    unsigned a=0, b=0, c=0, len=0;
